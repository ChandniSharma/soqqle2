...
export default class ProfileView extends Component {
    ...
    goToCompanyDetails = profile => this.props.navigation.navigate('CompanyProfile', {profile});
            ...
            <MenuProvider>
                <Container>
                    ...
                    <View style={styles.topProfile}>
                            ...
                            <Left>
                                ...
                                <Body>
                                    {isEdit ? <Item>
                                        ...
                                        style={styles.inputName}>{`${profile.firstName} ${profile.lastName || ''}`}</Text>
                                    }
                                    {isEdit ?
                        ...
                        <CardItem style={styles.blurBg}>
                            <Body>
                                {isEdit ? <Textarea placeholder="Type your bio"
                                    onChangeText={value => this.onChange('bio', value)}
                                    value={profile.bio}/> :
                        ...
                        <CardItem style={styles.blurBg}>
                            {
                                companies.map((company, index) =>
                                    <Button key={`company_${index}`} onPress={() => this.goToCompanyDetails(company)}
                                        small rounded
